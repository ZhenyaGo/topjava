...
public abstract class JdbcMealRepository<T> implements MealRepository {
    ...
    public static class HsqlDbJdbcMealRepository extends JdbcMealRepository<Timestamp> {
        @Override
        public Timestamp toDBDateTime (LocalDateTime localDateTime) {
    ...
    public static class PostgDbJdbcMealRepository extends JdbcMealRepository<LocalDateTime> {
        @Override
        public LocalDateTime toDBDateTime (LocalDateTime localDateTime) {
